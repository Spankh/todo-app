...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE task SET task = '$task', task_status = '$task_status' WHERE id = $task_id";
...
<form id="edit-task-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <input type="text" id="task-input" name="task" placeholder="Enter a task" value="<?php echo $task_data['task']; ?>" required autofocus><br><br>
